...
// 定例開催（自主企画）のセミナー。セミナーページの実績一覧の先頭に固定表示する
// period: 表示用の期間 / name: シリーズ名 / description: 曜日・時間・会場と現在の状況
export const regularSeminars = [
  {
    period: "2025年5月〜2026年5月",
    name: "木曜AIセミナー",
    description: "毎週木曜18:00・コトリ琴平で1年間開催",
  },
  {
    period: "2025年12月〜",
    name: "火曜AIセミナー",
    description: "毎週火曜13:00・琴平町総合センター。2026年7月から「あなたにもできる AI体験会」（第1・3火曜・象山）として継続中",
  },
];
